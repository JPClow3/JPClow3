# 👋 Olá, eu sou João Paulo G. Santos

Estudante de **Engenharia de Software (UniRV)**, focado em construir projetos práticos e evoluir como desenvolvedor Front-end.

- 🎯 Interesse principal: **Web Development**
- 🧠 Atualmente estudando: **TypeScript, Front-end e IA aplicada**
- 🤝 Aberto a: **estágio e colaboração em projetos acadêmicos**
...
### 1) League-AI-Oracle
Projeto em destaque no perfil, com foco em solução aplicada e experimentação com IA.

🔗 Repositório: [JPClow3/League-AI-Oracle](https://github.com/JPClow3/League-AI-Oracle)

### 2) Resonant-Echoes
Projeto autoral destacado no perfil para exploração de desenvolvimento e produto.

🔗 Repositório: [JPClow3/Resonant-Echoes](https://github.com/JPClow3/Resonant-Echoes)

### 3) Portfolio
Meu portfólio pessoal, centralizando apresentação profissional e projetos.

🔗 Repositório: [jpclow3/Portfolio](https://github.com/jpclow3/Portfolio)

### 4) Furia-Chat-Challenge
Chat bot temático como desafio prático de implementação.

🔗 Repositório: [JPClow3/Furia-Chat-Challenge](https://github.com/JPClow3/Furia-Chat-Challenge)
